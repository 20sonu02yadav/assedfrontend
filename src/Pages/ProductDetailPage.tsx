...
// //                   value={qty}
// //                   onChange={(e) => {
// //                     const parsed = Math.trunc(Number(e.target.value || 1));
...
// //     background: product.is_sale ? "#0b0b0b" : "#9ca3af",
...
//   const [qty, setQty] = useState(1);
//   const [tempQty, setTempQty] = useState("1"); // for manual editing
//   const [busyCart, setBusyCart] = useState(false);
//   const [activeTab, setActiveTab] = useState<"description" | "reviews">("description");
...
//   // Reset tempQty when product changes or quantity changes externally
//   useEffect(() => {
...
//   function handleQtyInputChange(value: string) {
//     setTempQty(value);
//   }
